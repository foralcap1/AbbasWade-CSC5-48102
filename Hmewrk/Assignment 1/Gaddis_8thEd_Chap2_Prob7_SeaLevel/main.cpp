/* 
   File:   main
   Author: Abbas, Wade
   Created on September 13, 2016, 11:54 AM
...
//Global Constants
const float CNVMMFT=304.8f; // Conversion from mm to feet from Google
const float CNVMMM=1000; //Conversion from mm to meters 
//Function prototypes

//Execution Begins Here!
int main(int argc, char** argv) {
    //Declaration of Variables with intitialization
    ...
    int nYrBch;//Number of years before your home is beachfront property
    ...
    cout<<"At this rate, Riverside won't have beach front property for  "<<endl;
